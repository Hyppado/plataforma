...
export function buildAvatarVideoCreation(
  ...
  return {
    ...
    uploadedAvatarImageUrl: null as string | null,
    customScenarioDescription: null as string | null,
    tone: null as string | null,
    duration: null as string | null,
    takeCount: null as number | null,
    errorMessage: null as string | null,
    selectedImageVariationId: null as string | null,
    createdAt: new Date(),
    updatedAt: new Date(),
