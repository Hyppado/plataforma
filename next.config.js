...
const nextConfig = {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://*.tiktokcdn.com https://*.tiktokcdn-us.com https://*.ibyteimg.com https://*.public.blob.vercel-storage.com https://*.img.susercontent.com https://*.shopee.com https://*.shopee.com.br https://*.shopeesz.com",
  ...
  images: {
    remotePatterns: [
      ...
      // CDN de imagem do TikTok Shop (capa dos produtos novos da EchoTik)
